...
<div className='flex gap-3 justify-between flex-col items-center '>
            ...
            <div className='flex w-full gap-3 justify-between flex-col items-center'>
                ...
                } className='w-full mt-5 text-white bg-[#80ef80] font-semibold p-2 rounded-lg '>Accept</button>
                ...
                } className='w-full mt-2 text-gray-700 bg-gray-300 font-semibold p-2 rounded-lg '>Ignore</button>
